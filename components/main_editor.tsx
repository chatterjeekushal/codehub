...
export default function MainEditor() {
    return (
        <div className="flex flex-col items-center justify-center w-full bg-[#0f1117]">
            {/* Full-screen responsive image with background */}
            <div className="relative w-full aspect-[16/9] sm:aspect-[16/9] md:aspect-auto md:h-screen bg-[#0f1117]">
                <Image
            ...
            {/* Responsive paragraph under the image */}
