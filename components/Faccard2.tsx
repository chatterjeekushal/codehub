...
export default function Card() {
    return (
        <div className="relative flex flex-col md:flex-row w-full  bg-[#6d8dce] shadow-sm  overflow-hidden md:h-90  sm:h-auto 2xl:mt-3">
            {/* Content Section */}
            <div className="p-6 lg:px-20 leading-3 flex flex-col justify-evenly w-full md:w-3/5">
                ...
                <Link
                    href="#"
                    className="text-black  font-semibold text-sm hover:underline flex items-center w-fit"
                >
                    Learn More
                    <svg
            ...
            {/* Image Section */}
            <div className="relative w-full md:w-2/5 h-64  md:h-auto xl:mt-6 xl:h-auto  ">
                <Image
                    src="https://res.cloudinary.com/db4ax3ufm/image/upload/v1752249661/inline_code_editor/Adobe_Express_-_file_3_xufghl.png"
